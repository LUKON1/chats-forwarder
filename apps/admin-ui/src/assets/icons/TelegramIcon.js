export default function TelegramIcon({ className = "w-6 h-6", fillColor = "#ffffff", bgClass = "fill-cerulean-500" }) {
  /* Telegram SVG icon from @thesvg/cli converted to React ES module */
  return (
    <svg 
      viewBox="0 0 256 256" 
